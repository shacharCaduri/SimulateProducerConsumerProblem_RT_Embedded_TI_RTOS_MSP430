...
C:/ti/tirtos_msp43x_2_14_03_28/products/bios_6_42_03_35/packages/ti/targets/msp430/elf/MSP430.xs:
package.mak: C:/ti/tirtos_msp43x_2_14_03_28/products/bios_6_42_03_35/packages/ti/targets/msp430/elf/MSP430.xs
C:/ti/tirtos_msp43x_2_14_03_28/products/bios_6_42_03_35/packages/ti/targets/msp430/elf/MSP430X.xs:
package.mak: C:/ti/tirtos_msp43x_2_14_03_28/products/bios_6_42_03_35/packages/ti/targets/msp430/elf/MSP430X.xs
C:/ti/tirtos_msp43x_2_14_03_28/products/bios_6_42_03_35/packages/ti/targets/msp430/elf/MSP430X_small.xs:
package.mak: C:/ti/tirtos_msp43x_2_14_03_28/products/bios_6_42_03_35/packages/ti/targets/msp430/elf/MSP430X_small.xs
C:/ti/tirtos_msp43x_2_14_03_28/products/bios_6_42_03_35/packages/ti/targets/msp430/elf/package.xs:
package.mak: C:/ti/tirtos_msp43x_2_14_03_28/products/bios_6_42_03_35/packages/ti/targets/msp430/elf/package.xs
...
ti.targets.msp430.elf.MSP430X.rootDir ?= C:/ti/ccsv6/tools/compiler/ti-cgt-msp430_4.4.5
ti.targets.msp430.elf.packageBase ?= C:/ti/tirtos_msp43x_2_14_03_28/products/bios_6_42_03_35/packages/ti/targets/msp430/elf/
...
.dlls,e430X .dlls: empty.pe430X

-include package/cfg/empty_pe430X.mak
-include package/cfg/empty_pe430X.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/empty_pe430X.dep
endif
empty.pe430X: package/cfg/empty_pe430X.xdl
	@


ifeq (,$(wildcard .libraries,e430X))
empty.pe430X package/cfg/empty_pe430X.c: .libraries,e430X
endif

package/cfg/empty_pe430X.c package/cfg/empty_pe430X.h package/cfg/empty_pe430X.xdl: override _PROG_NAME := empty.xe430X
package/cfg/empty_pe430X.c: package/cfg/empty_pe430X.cfg
package/cfg/empty_pe430X.xdc.inc: package/cfg/empty_pe430X.xdl
package/cfg/empty_pe430X.xdl package/cfg/empty_pe430X.c: .interfaces

clean:: clean,e430X
	-$(RM) package/cfg/empty_pe430X.cfg
	-$(RM) package/cfg/empty_pe430X.dep
	-$(RM) package/cfg/empty_pe430X.c
	-$(RM) package/cfg/empty_pe430X.xdc.inc

clean,e430X::
	-$(RM) empty.pe430X
.executables,e430X .executables: empty.xe430X

empty.xe430X: |empty.pe430X

-include package/cfg/empty.xe430X.mak
empty.xe430X: package/cfg/empty_pe430X.oe430X 
	$(RM) $@
	@$(MSG) lnke430X $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.msp430.elf.MSP430X.rootDir)/bin/lnk430 -w -q -u _c_int00 -fs $(XDCCFGDIR)$(dir $@).  -q -o $@ package/cfg/empty_pe430X.oe430X   package/cfg/empty_pe430X.xdl  -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.msp430.elf.MSP430X.rootDir)/lib/libc.a
	
empty.xe430X: export C_DIR=
empty.xe430X: PATH:=$(ti.targets.msp430.elf.MSP430X.rootDir)/bin/;$(PATH)
empty.xe430X: Path:=$(ti.targets.msp430.elf.MSP430X.rootDir)/bin/;$(PATH)

empty.test test,e430X test: empty.xe430X.test

empty.xe430X.test:: empty.xe430X
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 empty.xe430X.test
else
	@$(MSG) running $<  ...
	$(call EXEC.empty.xe430X, ) 
endif

clean,e430X::
	-$(RM) $(wildcard .tmp,empty.xe430X,*)
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
empty_pe430X.oe430X,copy : package/cfg/empty_pe430X.oe430X
empty_pe430X.se430X,copy : package/cfg/empty_pe430X.se430X
